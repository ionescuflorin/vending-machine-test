...
import { incrementBalance } from '../redux/actions';

const BanknotePanel = ({ banknotes, onBanknoteClick }) => (
  <section className="panel panel-primary">
    <div className="panel-heading">Load banknote</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BanknotePanel);
